...
const int k_generate_lmd       = 0x0002;
...
public:
    ...
    bool GenerateLMB(const wxString& sFilename, const wxString& sLangCode,
                     const wxString& sCharCode, int nOptions=0);
...
private:
    ...
    bool MusicfontTag(const wxXml2Node& oNode, lmContentStorage* pResult);
    ...
    bool StyleTag(const wxXml2Node& oNode, lmContentStorage* WXUNUSED(pResult));
    ...
    bool TocimageTag(const wxXml2Node& oNode, lmContentStorage* WXUNUSED(pResult));
    ...
    bool ScoreParamTag(const wxXml2Node& oNode, lmContentStorage* WXUNUSED(pResult));
    ...
    void CreatePageHeaders();
        //ZIP entries
    void create_mimetype_entry();

    // LMD helpers
    void TerminateArticleFile();
    void write_lmd_headers();
    void CreateArticleHeaders(wxString sBookTitle, wxString sHeaderTitle,
                           wxString sTitleNum);
    void add_lmd_layout();
    void terminate_lmd_layout();
    ...
    void CopyToLmb(wxString sFilename, const wxString& subfolder);
